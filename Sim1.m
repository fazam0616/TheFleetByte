...
persistent XYZ x_old y_old d HR spd frame HRS1 map HRnoise Rgnoise beatidx beat1
persistent hist_spd hist_HR hist_dr hist_XYZ hist_vel hist_hr hist_di hist_xyz hist_dh gbl
...
if (exist('xyz'))
    ...
    plot(hist_XYZ(:,1),hist_XYZ(:,2),'linewidth',5,'color',[0 0 1]);
    plot(hist_xyz(:,1),hist_xyz(:,2),'linewidth',5,'color',[1 0 0]);
